- [9. Ficheros y formatos de intercambio. Procesamiento masivo de información.](#9-ficheros-y-formatos-de-intercambio-procesamiento-masivo-de-información)
  - [Uso de recursos](#uso-de-recursos)
  - [Formatos de intercambio](#formatos-de-intercambio)
    - [CSV](#csv)
    - [JSON](#json)

# 9. Ficheros y formatos de intercambio. Procesamiento masivo de información.

> 📝 **Nota del Profesor**: El manejo de ficheros y formatos de intercambio es esencial para la integración de sistemas. JSON se ha convertido en el estándar de facto para el intercambio de datos.
...
> 💡 **Tip del Examinador**: Ten cuidado con los valores que contienen comas o saltos de línea. Usa bibliotecas como OpenCSV para manejar casos edge correctamente.
...
flowchart LR
    ...
    CSV -->|Lectura| Parser -->|Deserialización| Objetos
    Objetos -->|Escritura| Parser -->|Serialización| CSV
```

Ejemplo para leer el archivo CSV y convertir cada línea en un objeto Pokemon:
...
> ⚠️ **Advertencia de Seguridad**: Al deserializar JSON de fuentes no confiables, usa listas allowlists para las clases a deserializar para prevenir ataques de deserialización.
...
> 💡 **Tip del Examinador**: Jackson es más configurable y tiene mejor rendimiento, pero Gson es más sencillo de usar. Elige según las necesidades del proyecto.

Estos ejemplos están con [GSON](https://github.com/google/gson).
